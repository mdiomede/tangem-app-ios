...
extension GroupedSection: Setupable {
    ...
    func contentAlignment(_ alignment: HorizontalAlignment) -> Self {
        setup(\.contentAlignment, alignment)
    }
}
